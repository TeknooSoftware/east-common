...
namespace Teknoo\East\Website\Gedmo\Mapping\Driver;

use Teknoo\East\Website\Gedmo\Mapping\Driver;
...
class Chain implements Driver
{
    ...
    public function readExtendedMetadata($meta, array &$config)
    {
        ...
        //throw new \Teknoo\East\Website\Gedmo\Exception\UnexpectedValueException('Class ' . $meta->name . ' is not a valid entity or mapped super class.');
    }
