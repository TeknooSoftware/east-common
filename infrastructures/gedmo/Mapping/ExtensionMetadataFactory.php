...
use Teknoo\East\Website\Gedmo\Mapping\Driver\File as FileDriver;
use Teknoo\East\Website\Gedmo\Mapping\Driver\AnnotationDriverInterface;
...
class ExtensionMetadataFactory
{
    /**
     * Extension driver
     * @var \Teknoo\East\Website\Gedmo\Mapping\Driver
     */
    protected $driver;
     ...
     * @throws \Teknoo\East\Website\Gedmo\Exception\RuntimeException if driver was not found in extension
     * @return \Teknoo\East\Website\Gedmo\Mapping\Driver
     */
    protected function getDriver($omDriver)
    {
        ...
        if ($omDriver instanceof MappingDriverChain || $driverName == 'DriverChain') {
            ...
            if (!class_exists($driverClassName)) {
                ...
                if (!class_exists($driverClassName)) {
                    throw new \Teknoo\East\Website\Gedmo\Exception\RuntimeException("Failed to fallback to annotation driver: ({$driverClassName}), extension driver was not found.");
                }
            }
