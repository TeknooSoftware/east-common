...
namespace Teknoo\East\Website\Gedmo\Translatable\Document\Repository;

use Teknoo\East\Website\Gedmo\Translatable\TranslatableListener;
use Doctrine\ODM\MongoDB\Repository\DocumentRepository;
use Doctrine\ODM\MongoDB\Cursor;
use Doctrine\ODM\MongoDB\DocumentManager;
use Doctrine\ODM\MongoDB\UnitOfWork;
use Doctrine\ODM\MongoDB\Mapping\ClassMetadata;
use Teknoo\East\Website\Gedmo\Tool\Wrapper\MongoDocumentWrapper;
use Teknoo\East\Website\Gedmo\Translatable\Mapping\Event\Adapter\ODM as TranslatableAdapterODM;
...
class TranslationRepository extends DocumentRepository
{
    ...
    {
        if ($class->getReflectionClass()->isSubclassOf('Teknoo\East\Website\Gedmo\Translatable\Document\MappedSuperclass\AbstractPersonalTranslation')) {
            throw new \Teknoo\East\Website\Gedmo\Exception\UnexpectedValueException('This repository is useless for personal translations');
        }
    ...
    public function translate($document, $field, $locale, $value)
    {
        ...
        if (!isset($config['fields']) || !in_array($field, $config['fields'])) {
            throw new \Teknoo\East\Website\Gedmo\Exception\InvalidArgumentException("Document: {$meta->name} does not translate field - {$field}");
        }
     ...
     *
     * @throws \Teknoo\East\Website\Gedmo\Exception\RuntimeException - if listener is not found
     *
    ...
    private function getTranslatableListener()
    {
        if (!$this->listener) {
            ...
            throw new \Teknoo\East\Website\Gedmo\Exception\RuntimeException('The translation listener could not be found');
        }
