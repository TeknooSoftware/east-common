...
namespace Teknoo\East\Website\Gedmo\Translatable\Mapping\Driver;

use Teknoo\East\Website\Gedmo\Mapping\Driver\AbstractAnnotationDriver;
use Teknoo\East\Website\Gedmo\Exception\InvalidMappingException;
...
class Annotation extends AbstractAnnotationDriver
{
     ...
     */
    const ENTITY_CLASS = 'Teknoo\East\Website\Gedmo\\Mapping\\Annotation\\TranslationEntity';

    /**
     * Annotation to identify field as translatable
     */
    const TRANSLATABLE = 'Teknoo\East\Website\Gedmo\\Mapping\\Annotation\\Translatable';

    /**
     * Annotation to identify field which can store used locale or language
     * alias is LANGUAGE
     */
    const LOCALE = 'Teknoo\East\Website\Gedmo\\Mapping\\Annotation\\Locale';

    /**
     * Annotation to identify field which can store used locale or language
     * alias is LOCALE
     */
    const LANGUAGE = 'Teknoo\East\Website\Gedmo\\Mapping\\Annotation\\Language';
