...
namespace Teknoo\East\Website\Gedmo\Translatable\Mapping\Event\Adapter;

use Teknoo\East\Website\Gedmo\Mapping\Event\Adapter\ODM as BaseAdapterODM;
...
final class ODM extends BaseAdapterODM implements TranslatableAdapter
{
    ...
    public function usesPersonalTranslation($translationClassName)
    {
        return $this
            ...
            ->getReflectionClass()
            ->isSubclassOf('Teknoo\East\Website\Gedmo\Translatable\Document\MappedSuperclass\AbstractPersonalTranslation')
        ;
    }
    ...
    {
        return 'Teknoo\East\Website\Gedmo\\Translatable\\Document\\Translation';
    }
    ...
    public function insertTranslationRecord($translation)
    {
        ...
        if (!$collection->insert($data)) {
            throw new \Teknoo\East\Website\Gedmo\Exception\RuntimeException('Failed to insert new Translation record');
        }
    }
