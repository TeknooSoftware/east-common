...
namespace Teknoo\East\Website\Gedmo\Translator;
...
class TranslationProxy
{
    ...
    public function __construct($translatable, $locale, array $properties, $class, Collection $coll)
    {
        ...
        if (!$translationClass->implementsInterface('Teknoo\East\Website\Gedmo\Translator\TranslationInterface')) {
            throw new \InvalidArgumentException(sprintf(
                'Translation class should implement Teknoo\East\Website\Gedmo\Translator\TranslationInterface, "%s" given',
                $class
            ));
        }
    }
