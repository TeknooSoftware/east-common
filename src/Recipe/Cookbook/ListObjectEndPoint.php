...
use Teknoo\East\Common\Recipe\Plan\ListObjectEndPoint as OriginalPlan;
 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @deprecated Use `Teknoo\East\Common\Recipe\Plan\ListObjectEndPoint` instead
 */
class ListObjectEndPoint extends OriginalPlan implements ListObjectEndPointInterface
{
}
