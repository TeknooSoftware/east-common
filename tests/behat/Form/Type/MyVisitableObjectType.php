 ...
 * @author      Richard Déloge <richard@teknoo.software>
 */
class MyVisitableObjectType extends AbstractType
{
    public function __construct(
        private readonly EastDataMapper $eastDataMapper,
    ) {
    }

    /**
     * @param FormBuilderInterface<MyVisitableObject> $builder
     * @param array<string, mixed> $options
     */
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->setDataMapper($this->eastDataMapper->configure(MyVisitableObject::class));
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setDefaults([
            'data_class' => MyVisitableObject::class,
