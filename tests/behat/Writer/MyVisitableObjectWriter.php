 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements WriterInterface<MyVisitableObject>
 */
class MyVisitableObjectWriter implements WriterInterface
{
    /**
     * @use PersistTrait<MyVisitableObject>
     */
    use PersistTrait;
    ...
    public function save(
        ...
        if ($object instanceof MyVisitableObject) {
            $object->setSaved('foo');
        }
